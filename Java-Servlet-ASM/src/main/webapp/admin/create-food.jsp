            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Create Foods </h3>
                        <p class="text-subtitle text-muted">Create new food in your restaurant</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Enter food information</h4>
                    </div>
                    <div class="card-body">
                        <p class="text-danger" id="validate-status">${requestScope.status}</p>
                        <form action="/admin/food/create" method="post" id="create-food-form">
                            <div class="row">
