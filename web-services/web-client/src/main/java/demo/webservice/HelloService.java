 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://demo/", wsdlLocation = "http://localhost:9999/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://demo/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/helloService?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://demo/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo/", "HelloPort"), Hello.class, features);
    }
